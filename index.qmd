...
Afin d'obtenir les informations sous-jacentes des informations bibliographiques, j'ai commencé à travailler à la cration d'un réseau de co-auteur. Pour l'instant, la fonctionalité n'existe qu'au format de script R. Au cours des semaines restantes, l'objectif est de continuer à travailler dessus et créer des fonctions simples et claires permettant à l'utilisateur de créer son propre réseau à partir de ses données.
