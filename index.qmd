---
title: "Mémoire de stage - ManagHAL"
author: 
  - name: "Martin AMIENS"
  - affiliations:
...
# Noms des nœuds dans chaque ensemble
nodes_A <- c("A1", "A2", "A3")
nodes_B <- c("B1", "B2", "B3", "B4")

# Liste des arêtes (chaque arête est une paire (nœud de A, nœud de B))
edges <- c("A1", "B1", "A1", "B2","A2", "B1", "A2", "B2", "A2", "B3", "A3", "B2", "A3", "B4")

# Créer un graphe bipartite
g <- graph(edges, directed = FALSE)

# Définir l'attribut bipartite (type) pour les nœuds
