...
Cette partie est principalement basée sur la publication "Using Latent Block Models to Detect Structure in Ecological Networks" [@latent-block-models](https://onlinelibrary.wiley.com/doi/10.1002/9781119902799.ch6).
...
Ce script permet de réaliser un modèle en bloc stochastiques depuis le réseau créé dans l'annexe [Script_R_reseau_co-auteur](#reseau-co-auteur).
