...
Comme précisé dans l'introduction l'entiereté des méthodes informatiques développés ont été réalisé sur Rstudio. J'ai donc travaillé avec le language R. Les packages utilisés sont : faire la liste des packages utilisés...
expliquer l'api HAL ?? peut etre en parler dans l'intro
