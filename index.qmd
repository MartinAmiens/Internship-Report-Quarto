...
```{r chargement des librairies, echo = FALSE, warning = FALSE, message=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r run example load_team_table, warning=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r exemple utiliation HAL extract csv, tidy.opts=list(width.cutoff=60)}
date_min = "01/01/2022"
date_max = "01/01/2023"
...
```{r load_team_table_url example, eval=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r load_team_table_csv example, eval=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r load_team_table example, eval=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r hal query, tidy.opts=list(width.cutoff=60)}
...
```{r script reseau co auteur, eval=FALSE, tidy.opts=list(width.cutoff=60)}
...
```{r exemple de reseau, eval = FALSE, tidy.opts=list(width.cutoff=60)}
