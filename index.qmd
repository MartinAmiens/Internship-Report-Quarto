...
![Réseau co-auteur](figures/Full_Network_Co-authors_Example_managHAL.jpeg){width="648"}

A travers cet exemple, les limitations de la création de réseau sur les données récupérées via un identifiant de laboratoire transparaissent. De fait, on voit l'appartition de cercle de co-auteurs très denses. Ces cercles correspondent généralement à une unique publication contenant de nombreux auteurs. J'ai tout de même réalisé un modèle en bloc stochastique sur ce réseau (voir le code en annexe :[]()) mettre un exemple des couleurs obtenues. 
